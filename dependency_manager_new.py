...
def ensure_dependencies():
    ...
    if not manager.is_initialized():
        ...
        print("🔄 Sprawdzanie czy nie brakuje nowych pakietów...")
        missing = manager.check_missing_packages()
        if missing:
            print(f"\n❌ Nowe brakujące pakiety: {', '.join(missing)}")
            ...
            if manager.install_missing_packages(missing):
                ...
                print("✅ Nowe pakiety zainstalowane")
        else:
            print("✅ Wszystkie zależności są aktualne!")
