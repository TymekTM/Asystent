#!/usr/bin/env python3
"""Test specjalnie dla funkcji ask_for_clarification Test scenariuszy, gdzie AI powinno
    ...
    for i, test in enumerate(clarification_tests, 1):
        ...
        try:
            async with websockets.connect(
                "ws://localhost:8001/ws/clarification_test"
            ) as websocket:
                # Wait for handshake
                ...
                if response_data.get("type") == "clarification_request":
                    ...
                    print(
                        f"❓ Unexpected response: {response_data.get('type', 'unknown')}"
                    )
