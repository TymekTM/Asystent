#!/usr/bin/env python3
"""Test kompletnego systemu GAJA Sprawdza komunikację między overlay, klientem i
serwerem."""
...
class SystemTester:
    ...
    async def test_server_health(self):
        ...
        try:
            ...
            return await self.test_websocket_connection(
                "ws://localhost:8001/ws/test_client", "Serwer GAJA"
            )
        except Exception as e:
    ...
    async def test_client_websocket(self):
        ...
        try:
            return await self.test_websocket_connection(
                "ws://localhost:6001", "Klient WebSocket"
            )
        except Exception as e:
