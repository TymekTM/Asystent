...
Tests the async handler methods added to fix the missing method errors.
...
class TestClientHandlers:
    ...
    async def test_handle_proactive_notifications_high_priority(self, client_app):
        ...
        client_app.tts.speak.assert_called_once_with("Urgent: Urgent notification message")
    ...
    def test_format_day_summary_with_content(self, client_app):
        ...
        result = client_app._format_day_summary(
            "test_summary", 
            "Test content", 
            {}
        )
    ...
    def test_format_day_summary_with_statistics(self, client_app):
        ...
        expected = "Statystyki dnia: 7.5 godzin aktywności, 12 interakcji, produktywność: 78%."
