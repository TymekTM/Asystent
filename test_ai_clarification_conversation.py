            ...
            for i, scenario in enumerate(test_scenarios, 1):
                ...
                try:
                    ...
                    if response_data.get("type") == "clarification_request":
                        ...
                        print(f"❓ Question: {clarification.get('question', 'No question')}")
                        print(f"📝 Context: {clarification.get('context', 'No context')}")
                        ...
                        print(f"🔄 Sending clarification: {clarification_response['query']}")
                        ...
                        clarification_indicators = [
                            "nie podał", "jakiej", "jakiego", "gdzie", "kiedy", 
                            "więcej", "sprecyzuj", "dla jakiego miasta", "co dokładnie"
                        ]
                        
                        if any(indicator in ai_text.lower() for indicator in clarification_indicators):
                            print("✅ GOOD: AI recognized need for clarification in text")
                        else:
