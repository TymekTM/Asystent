...
async def debug_single_test():
    ...
    try:
        ...
        try:
            ...
            logger.info(
                f"📊 Parsed response: {json.dumps(parsed_response, indent=2, ensure_ascii=False)}"
            )
                ...
                if "response" in data:
                    ...
                    if isinstance(response_content, str):
                        try:
                            ...
                            logger.info(
                                f"✅ Parsed response content: {json.dumps(parsed_content, indent=2, ensure_ascii=False)}"
                            )
