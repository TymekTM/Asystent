...
Following AGENTS.md guidelines: comprehensive async testing.
"""
...
from dependency_manager import DependencyManager, Dependency, get_dependency_manager, DependencyContext
    ...
    async def test_full_installation_workflow(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch('asyncio.create_subprocess_exec') as mock_subprocess:
                ...
                essential_deps = [name for name, dep in manager.HEAVY_DEPENDENCIES.items() if dep.essential]
