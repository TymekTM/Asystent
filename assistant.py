...
class Assistant:
    def __init__(
        ...
        # Ustawienie alternatywnej metody STT opartej na Whisper
    ...
    def process_audio(self):
        ...
        while True:
            ...
            # Wykrycie wake word przy użyciu vosk
            if self.wake_word in partial_text:
                logger.info("Wake word detected in partial result.")
                self.tts.cancel()  # Przerywamy TTS
                # Odtwarzamy beep przy rozpoczęciu nagrywania
