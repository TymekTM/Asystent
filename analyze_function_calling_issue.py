...
async def test_direct_modules():
    ...
    try:
        ...
        from server.modules import weather_module, search_module, core_module, music_module, api_module, open_web_module
...
async def create_direct_function_test():
    ...
    payload = {
        "type": "patch_function_calling",
        "action": "use_direct_modules"
    }
