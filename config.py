...
USE_WHISPER_FOR_COMMAND = DEFAULT_CONFIG["USE_WHISPER_FOR_COMMAND"]
...
def load_config(path=CONFIG_FILE_PATH):
    global _config, ASSISTANT_NAME, WAKE_WORD, WAKE_WORD_SENSITIVITY_THRESHOLD, LANGUAGE, \
           ...
           STT_MODEL, MAIN_MODEL, PROVIDER, DEEP_MODEL, USE_WHISPER_FOR_COMMAND, WHISPER_MODEL, \
           ...
           VOSK_MODEL_PATH, MIC_DEVICE_ID, STT_SILENCE_THRESHOLD, API_KEYS, query_refinement, version, \
    ...
    VOSK_MODEL_PATH = _config.get("VOSK_MODEL_PATH", DEFAULT_CONFIG["VOSK_MODEL_PATH"])
    ...
    USE_WHISPER_FOR_COMMAND = _config.get("USE_WHISPER_FOR_COMMAND", DEFAULT_CONFIG["USE_WHISPER_FOR_COMMAND"])
