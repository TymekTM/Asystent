    ...
    async def run_comprehensive_test(self):
        ...
        test_scenarios = [
            ...
            },
            {
                ...
                'params': {'title': 'Meeting z AI', 'date': '2024-01-15', 'time': '14:00'}
            },
            {
        ...
        for i, scenario in enumerate(test_scenarios, 1):
            ...
            print(f"📝 Parametry: {json.dumps(scenario['params'], ensure_ascii=False, indent=2)}")
        ...
        for func_key, func_info in all_functions.items():
            ...
            if params:
                ...
                for param_name, param_info in params.items():
                    ...
                    print(f"  • {param_name}: {param_info.get('description', 'Brak opisu')}{required_mark}")
            else:
