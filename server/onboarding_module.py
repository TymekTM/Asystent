"""
Onboarding Module for GAJA Assistant Server
Obsługa pierwszego uruchomienia i konfiguracji wstępnej w architekturze klient-serwer.
"""
    ...
    async def get_onboarding_status(self, user_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "completed_steps": user_data.get('onboarding_steps', []) if user_data else []
            }
        except Exception as e:
            logger.error(f"Error getting onboarding status: {e}")
            return {"error": str(e)}
    
    async def save_onboarding_step(self, user_id: str, step: str, data: Dict[str, Any]) -> Dict[str, Any]:
...
async def save_onboarding_step(user_id: str, step: str, data: str) -> Dict[str, Any]:
    ...
    try:
        ...
        if hasattr(server_app, 'onboarding_module'):
            return await server_app.onboarding_module.save_onboarding_step(user_id, step, data)
        return {"error": "Onboarding module not available"}
    except Exception as e:
