...
class ConnectionManager:
    ...
    async def disconnect(self, user_id: str, reason: str = "normal"):
        ...
        try:
            if user_id in self.active_connections:
                ...
                logger.info(f"WebSocket disconnected for user {user_id} (reason: {reason})")
    ...
    async def broadcast(self, message: WebSocketMessage, exclude_users: Set[str] = None):
    ...
    async def handle_message(self, user_id: str, message_data: dict) -> Optional[dict]:
