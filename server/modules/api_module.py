    ...
    return [
        {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "params": {
                        "type": "object",
                        "description": "Parametry URL"
                    },
                    "json_data": {
                        "type": "object",
                        "description": "Dane JSON w body"
                    }
                },
                "required": ["method", "url"]
            }
...
class APIModule:
    ...
    async def make_request(self, user_id: int, method: str, url: str, 
    ...
    async def call_anthropic_api(self, user_id: int, user_api_key: str,
                                messages: List[Dict[str, str]],
    ...
    async def search_web(self, user_id: int, query: str, 
                        api_key: str = None, engine: str = "google") -> Dict[str, Any]:
        """
    ...
    async def translate_text(self, user_id: int, text: str, target_lang: str,
    ...
    async def get_news(self, user_id: int, api_key: str,
