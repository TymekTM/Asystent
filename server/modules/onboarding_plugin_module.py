"""
Onboarding Module for Plugin System
Moduł onboarding dostępny przez system pluginów.
"""
...
class OnboardingPluginModule:
    ...
    async def save_onboarding_step(self, user_id: str, step: str, data: str) -> Dict[str, Any]:
