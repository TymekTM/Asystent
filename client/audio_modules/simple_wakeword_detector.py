...
class WakewordDetector:
    ...
    def __init__(self, config: Dict[str, Any], callback: Callable):
        ...
        logger.info(f"WakewordDetector initialized for keyword '{self.keyword}' with sensitivity {self.sensitivity}")
    ...
    async def start(self):
        ...
        if not self.sounddevice_available:
            logger.warning("Cannot start wakeword detection - sounddevice not available")
            return
