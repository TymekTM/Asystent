...
async def test_clarification_function():
    ...
    try:
        ...
        print("\n📝 Test 2: Without context")
        params = {
            "question": "Jakiej muzyki chcesz posłuchać?"
        }
...
async def test_function_calling_integration():
    ...
    try:
        ...
        if clarification_functions:
            ...
            print(f"   Parameters: {json.dumps(func['function']['parameters'], indent=2)}")
            ...
            print("❌ ask_for_clarification function not found in function calling system")
